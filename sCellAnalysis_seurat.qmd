...
```{r}
# RUN THIS ON R SERVER (TAKES TIME)
#library(future)
...
The HPCA database resulted in a bad cell type annotation. In this case we should have used a specific airway epithelium database (Over 10gb - Takes too long to run)
